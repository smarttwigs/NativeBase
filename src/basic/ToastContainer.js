...
class ToastContainer extends Component {
  ...
  componentDidMount() {
    this._keyboardDidShow = Keyboard.addListener('keyboardDidShow', this.keyboardDidShow);
    this._keyboardDidHide = Keyboard.addListener('keyboardDidHide', this.keyboardDidHide);
  }
